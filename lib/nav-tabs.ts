...
export const classicTabs: NavTab[] = [
  ...
  },
  {
    ...
    href: "/carriear",
    live: false,
    tagline: "Build your carrier — careers, coaching and growth.",
    sub: [
      { label: "Career paths", href: "/carriear#paths" },
      { label: "Coaching", href: "/carriear#coaching" },
      { label: "Resume help", href: "/carriear#resume" },
      { label: "Interviews", href: "/carriear#interviews" },
    ],
  },
  {
    id: "entertainmen",
    ...
    sub: [
      { label: "Events", href: "/entertainmen#events" },
      { label: "Media", href: "/entertainmen#media" },
      { label: "Content", href: "/entertainmen#content" },
    ],
  },
  {
    id: "gift",
