...
const en: Dict = {
  ...
  "nav.search": "Anything You Think You Want, Then Search in Lawfic, 51000+ Services, 21000+ Professional Experts, 1000+ Connecting Stores* & many more.........",
  "nav.searchShort": "Search services and documents",
...
const hi: Dict = {
  ...
  "nav.search": "जो कुछ भी आपके मन में है, LAWFIC में खोजिए — 51000+ सेवाएँ, 21000+ पेशेवर विशेषज्ञ, 1000+ जुड़े हुए स्टोर* और भी बहुत कुछ.........",
  "nav.searchShort": "सेवाएँ और दस्तावेज़ खोजें",
...
const es: Dict = {
  ...
  "nav.search": "Lo que se te ocurra, búscalo en LAWFIC: más de 51 000 servicios, 21 000 profesionales, 1000 tiendas conectadas* y mucho más.........",
  "nav.searchShort": "Buscar servicios y documentos",
