        ...
        {open && (
          ...
          >
            <form
              ...
              className="mt-5 max-w-lg rounded border border-line-2 bg-surface/40 p-5"
            >
              <label htmlFor="details" className="label text-slate">
              ...
              <textarea
                ...
                className="mt-2.5 w-full rounded border border-line-2 bg-ink/60 px-3 py-2.5 text-[14px] leading-relaxed text-bone outline-none focus:border-brass-lo placeholder:text-slate/60"
              />

              <button
                type="submit"
                disabled={pending}
                className="mt-4 w-full rounded-full bg-brass py-3 text-sm font-medium text-ink transition-colors hover:bg-brass-hi disabled:cursor-not-allowed disabled:bg-surface-3 disabled:text-slate sm:w-auto sm:px-7"
              >
